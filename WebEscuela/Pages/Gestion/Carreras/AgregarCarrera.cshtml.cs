...
{
    public class AgregarCarreraModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            {
                TempData["ErrorMessage"] = "Acceso denegado: Solo administradores pueden crear carreras.";
        ...
        {
            // Recargar Dropdowns antes de validar
            await CargarDatosIniciales();
            ...
            //  Crear carrera
            var (success, error) = await _carreraService.CrearCarrera(
                Nombre: Input.Nombre,
                Sigla: Input.Siglas,
                DuracionAnios: Input.Duracion,
                ModalidadId: Input.ModalidadId!.Value,
                TurnoId: Input.TurnoId!.Value,
            ...
            if (success)
            {
                TempData["SuccessMessage"] = $"La carrera '{Input.Nombre}' fue creada exitosamente.";
